// ================================
// Builds /react/app/ SeeVee Frontend
// ================================
...
module.exports = {
  ...
  plugins: [
    ...
    NODE_ENV === 'production' ? new webpack.optimize.UglifyJsPlugin({ minimize: true, compress: { warnings: false } } ) : () => {},
  ],
  ...
  module: {
    loaders: [
      ...
      { test: /\.scss$/, loader: ExtractTextPlugin.extract('style-loader', 'css-loader?modules&importLoaders=1&localIdentName=[local]!postcss-loader!sass') },
